...
from orb.agent.orchestrator.task_decomposer import Task, TaskDecomposer
from orb.agent.orchestrator.flow_controller import FlowController, ExecutionContext
from orb.system.brain_pipeline.protocol import Message, MessageType, TaskRequest, TaskResponse
from orb.system.services.logger import AgentLoggerMixin, trace_context, Layer
...
class OrchestratorAgent(BaseAgent):
    ...
    def _build_robot_system_prompt(self) -> str:
        """构建机器人系统提示词"""
        return """你是OpenRoboBrain机器人大脑系统的编排Agent。
