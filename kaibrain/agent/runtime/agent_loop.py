...
if TYPE_CHECKING:
    ...
    from kaibrain.agent.infrastructure.workspace import WorkspaceManager
    from kaibrain.agent.runtime.context_builder import ContextBuilder, AgentContext
    from kaibrain.agent.runtime.tool_executor import ToolExecutor, ToolCall, ToolResult
