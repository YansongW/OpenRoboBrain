...
if TYPE_CHECKING:
    ...
    from kaibrain.behavior.executor import BehaviorExecutor
    from kaibrain.behavior.base import BehaviorResult
...
class KaiBrain:
    ...
    async def initialize(self) -> None:
        ...
        from kaibrain.behavior.executor import BehaviorExecutor
        from kaibrain.behavior.registry import get_registry
    ...
    async def process(
        ...
        try:
            # 检查系统是否运行
            if not self._running:
                raise RuntimeError("KaiBrain系统未启动")
